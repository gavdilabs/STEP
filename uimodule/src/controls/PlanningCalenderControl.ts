 ...
 */
export default class PlanningCalendarControl extends Control{
    static readonly metadata = {
        properties: {
            "mId" : {type: "string", defaultValue: "itemx_"},
            "projectStartDate" : {type: "string", defaultValue: ""},
        ...
        aggregations: {
            items: {
                type: "com.gavdilabs.finalchallenge.control.ProjectListItem",
                multiple: true,
                singularName: "item"
            }
        },
    ...
    static renderer= function(oRM: RenderManager, oCtrl: PlanningCalendarControl){
        ...
        $.each(oCtrl.getItems(), function(key, value){
            const value2 = value as ProjectListItem
            value2.setCustomerID(oCtrl.getCustomerID())
