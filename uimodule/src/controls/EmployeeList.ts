...
export default class EmployeeList extends Control{
    static readonly metadata = {
        ...
        aggregations: {
            items: {
                type: "com.gavdilabs.finalchallenge.control.EmployeeListItem",
                multiple: true,
                singularName: "item"
            }
        },
    ...
    static renderer = function(oRM: RenderManager, oCtrl: EmployeeList){
