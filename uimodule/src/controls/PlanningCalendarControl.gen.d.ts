...
declare module "./PlanningCalenderControl" {

    /**
     * Interface defining the settings object used in constructor calls
     */
    interface $PlanningCalendarControlSettings extends $ControlSettings {
        mId?: string | PropertyBindingInfo;
        projectStartDate?: string | PropertyBindingInfo;
        rows?: string | PropertyBindingInfo;
    ...
    export default interface PlanningCalendarControl {
        ...
        setProjectStartDate(projectStartDate: string): this;
